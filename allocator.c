...
void *vlad_malloc(u_int32_t n)
{
  ...
  //find the best location to allocate
...
//  find where to insert freed object
...
//check whether curr can merge left or right until it can not merge left or right
